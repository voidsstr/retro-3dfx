...
void APIENTRY __glim_GetTexEnvfv(GLenum target,
                        GLenum pname, GLfloat v[])
{
    ...
    switch (pname) {
      case GL_TEXTURE_ENV_MODE:
        v[0] = gc->state.texture[gc->texture.currentTexUnit].env[0].mode;
        break;
      case GL_TEXTURE_ENV_COLOR:
        __glUnScaleColorf(gc, v, &gc->state.texture[gc->texture.currentTexUnit].env[0].color);
        break;
      default:
        __glSetError(GL_INVALID_ENUM);
        return;
...
void APIENTRY __glim_GetTexEnviv(GLenum target,
                         GLenum pname, GLint v[])       
{
    ...
    switch (pname) {
      case GL_TEXTURE_ENV_MODE:
        ...
        break;
      case GL_TEXTURE_ENV_COLOR:
        __glUnScaleColori(gc, v, &gc->state.texture[gc->texture.currentTexUnit].env[0].color);
        break;
      default:
        __glSetError(GL_INVALID_ENUM);
        return;
...
void APIENTRY __glim_GetTexGenfv(GLenum coord, GLenum pname,
                        GLfloat v[])
{
    ...
    switch (coord) {
      case GL_S:
        tcs = &gc->state.texture[gc->texture.currentTexUnit].s;
        break;
      case GL_T:
        tcs = &gc->state.texture[gc->texture.currentTexUnit].t;
        break;
      case GL_R:
        tcs = &gc->state.texture[gc->texture.currentTexUnit].r;
        break;
      case GL_Q:
        tcs = &gc->state.texture[gc->texture.currentTexUnit].q;
        break;
      default:
        __glSetError(GL_INVALID_ENUM);
        return;
...
void APIENTRY __glim_GetTexGendv(GLenum coord, GLenum pname,
                        GLdouble v[])
{
    __GLtextureCoordState* tcs;
    __GL_SETUP_NOT_IN_BEGIN();
...
void APIENTRY __glim_GetTexGeniv(GLenum coord, GLenum pname,
                        GLint v[])
{
    __GLtextureCoordState* tcs;
    __GL_SETUP_NOT_IN_BEGIN();
...
void APIENTRY __glim_GetTexParameterfv(GLenum target,
                              GLenum pname, GLfloat v[])
{
...
void APIENTRY __glim_GetTexParameteriv(GLenum target,
                              GLenum pname, GLint v[])
{
    __GLtextureParamState *pts;
    __GL_SETUP_NOT_IN_BEGIN();
...
void APIENTRY __glim_GetTexLevelParameterfv(GLenum target, GLint level,
                                   GLenum pname, GLfloat v[])
{
    __GLtexture *tex;
    __GLmipMapLevel *lp;
...
void APIENTRY __glim_GetTexLevelParameteriv(GLenum target, GLint level,
                                   GLenum pname, GLint v[])
{
    __GLtexture *tex;
    __GLmipMapLevel *lp;
...
void APIENTRY __glim_GetClipPlane(GLenum plane, GLdouble eqn[4])
{
    GLint index;
    __GL_SETUP_NOT_IN_BEGIN();
    __GL_API_GET();
...
void APIENTRY __glim_GetTexImage(GLenum target, GLint level, GLenum format, GLenum type,
                        GLvoid *texels)
{
...
void APIENTRY __glim_GetPolygonStipple(GLubyte *outImage)
{
    __GLpixelSpanInfo spanInfo;
    __GL_SETUP_NOT_IN_BEGIN();
    __GL_API_GET();
...
void APIENTRY __glim_GetLightfv(GLenum light, GLenum pname,
                       GLfloat result[])
{
    GLint index;
...
void APIENTRY __glim_GetLightiv(GLenum light, GLenum pname,
                       GLint result[])
{
    GLint index;
    __GLlightSourceState *src;
...
void APIENTRY __glim_GetMaterialfv(GLenum face, GLenum pname,
                          GLfloat result[])
{
    ...
    switch (pname) {
      ...
      case GL_INDEX_OFFSET:
        result[0] = mat->indexOffset;
        break;
      case GL_INDEX_SHIFT:
        result[0] = mat->indexShift;
        break;
      default:
        __glSetError(GL_INVALID_ENUM);
        return;
...
void APIENTRY __glim_GetMaterialiv(GLenum face, GLenum pname,
                          GLint result[])
{
    __GLmaterialState *mat;
    __GL_SETUP_NOT_IN_BEGIN();
    ...
    switch (pname) {
      ...
      case GL_SPECULAR:
        ...
        break;
      case GL_INDEX_OFFSET:
        result[0] = __GL_FLOAT_TO_I(mat->indexOffset);
        break;
      case GL_INDEX_SHIFT:
        result[0] = __GL_FLOAT_TO_I(mat->indexShift);
        break;
      default:
        __glSetError(GL_INVALID_ENUM);
        return;
...
void APIENTRY __glim_GetMapfv(GLenum target, GLenum query, GLfloat buf[])
{
...
void APIENTRY __glim_GetMapdv(GLenum target, GLenum query, GLdouble buf[])
{
    __GLevaluator1 *eval1;
    __GLevaluator2 *eval2;
    __GLfloat *eval1Data, *eval2Data;
...
void APIENTRY __glim_GetMapiv(GLenum target, GLenum query, GLint buf[])
{
    __GLevaluator1 *eval1;
    __GLevaluator2 *eval2;
    __GLfloat *eval1Data, *eval2Data;
...
void APIENTRY __glim_GetPixelMapfv(GLenum map, GLfloat buf[])
{
    GLint index;
    GLint limit;
    GLfloat *rp;
...
void APIENTRY __glim_GetPixelMapuiv(GLenum map, GLuint buf[])
{
    GLint index;
    GLint limit;
    GLuint *rp;
...
void APIENTRY __glim_GetPixelMapusv(GLenum map, GLushort buf[])
{
    GLint index;
    GLint limit;
    GLushort *rp;
...
void __glDoGet(GLenum sq, void *result, GLint type, const char *procName)
{
    ...
    switch (sq) {
      ...
      case GL_MAX_TEXTURE_UNITS_ARB:
        *ip++ = (gc->grNTexelFx > 1) ? 2 : 1;
        break;
      case GL_ACTIVE_TEXTURE_ARB:
        *ip++ = GL_TEXTURE0_ARB + gc->texture.currentTexUnit;
        break;
      case GL_CLIENT_ACTIVE_TEXTURE_ARB:
        *ip++ = GL_TEXTURE0_ARB + gc->vertexArray.clientTexUnit;
        break;
      ...
      case GL_CURRENT_COLOR:
        *scp++ = gc->state.current.color.r;
        *scp++ = gc->state.current.color.g;
        *scp++ = gc->state.current.color.b;
        *scp++ = gc->state.current.color.a;
        break;
      ...
      case GL_CURRENT_TEXTURE_COORDS:
        *fp++ = gc->state.current.texture[0].x;
        *fp++ = gc->state.current.texture[0].y;
        *fp++ = gc->state.current.texture[0].z;
        *fp++ = gc->state.current.texture[0].w;
        break;
      ...
      case GL_CURRENT_RASTER_TEXTURE_COORDS:
        *fp++ = gc->state.current.rasterPos.texture[0].x;
        *fp++ = gc->state.current.rasterPos.texture[0].y;
        *fp++ = gc->state.current.rasterPos.texture[0].z;
        *fp++ = gc->state.current.rasterPos.texture[0].w;
        break;
      ...
      case GL_POINT_SIZE_MIN_EXT:
        *fp++ = gc->state.point.min;
        break;
      case GL_POINT_SIZE_MAX_EXT:
        *fp++ = gc->state.point.max;
        break;
      case GL_POINT_FADE_THRESHOLD_SIZE_EXT:
        *fp++ = gc->state.point.fadeThreshold;
        break;
     case GL_DISTANCE_ATTENUATION_EXT:
      ...
      case GL_COLOR_MATERIAL_PARAMETER:
        *ip++ = gc->state.light.colorMaterialParam;
        break;
      case GL_INDEX_MATERIAL_FACE_SGI:
        *ip++ = gc->state.light.indexMaterialFace;
        break;
      case GL_INDEX_MATERIAL_PARAMETER_SGI:
        *ip++ = gc->state.light.indexMaterialParam;
        break;
      case GL_SHADE_MODEL:
      ...
      case GL_TEXTURE_STACK_DEPTH:
        *ip++ = 1 + (gc->transform.texture[gc->texture.currentTexUnit] - gc->transform.textureStack[gc->texture.currentTexUnit]);
        break;
      ...
      case GL_TEXTURE_MATRIX:
        mp = &gc->transform.texture[gc->texture.currentTexUnit]->matrix.matrix[0][0];
        *fp++ = *mp++; *fp++ = *mp++; *fp++ = *mp++; *fp++ = *mp++;
        *fp++ = *mp++; *fp++ = *mp++; *fp++ = *mp++; *fp++ = *mp++;
        *fp++ = *mp++; *fp++ = *mp++; *fp++ = *mp++; *fp++ = *mp++;
        *fp++ = *mp++; *fp++ = *mp++; *fp++ = *mp++; *fp++ = *mp++;
      ...
      case GL_ALPHA_TEST_REF:
        *fp++ = gc->state.raster.alphaReference;
        break;
      case GL_INDEX_TEST_FUNC_SGI:
        *ip++ = gc->state.raster.indexFunction;
        break;
      case GL_INDEX_TEST_REF_SGI:
        *fp++ = gc->state.raster.indexReference;
        break;
      case GL_BLEND_DST:
      ...
      case GL_STENCIL_BITS:
        *ip++ = gc->modes.stencilBits;
        break;
        /*
         * In SGI's implementations the accum buffer always has same size RGBA
         * components, but we do have separate fields in the modes buffer, so
         * we use them
         */
      ...
      case GL_TEXTURE_BINDING_1D:
        {
            __GLtextureObjectState *ptos;
            ptos = __glLookUpTextureTexobjs(gc, GL_TEXTURE_1D, gc->texture.currentTexUnit);
            *ip++ = ptos->name;
        }
        break;
      case GL_TEXTURE_BINDING_2D:
        {
            __GLtextureObjectState *ptos;
            ptos = __glLookUpTextureTexobjs(gc, GL_TEXTURE_2D, gc->texture.currentTexUnit);
            *ip++ = ptos->name;
        }
        break;
      case GL_VERTEX_ARRAY_SIZE:
        *ip++ = gc->vertexArray.vp_size;
        break;
      case GL_VERTEX_ARRAY_TYPE:
        *ip++ = gc->vertexArray.vp_type;
        break;
      case GL_VERTEX_ARRAY_STRIDE:
        *ip++ = gc->vertexArray.vp_usr_stride;
        break;
      case GL_VERTEX_ARRAY_COUNT_EXT:
        *ip++ = gc->vertexArray.vp_count;
        break;
      case GL_NORMAL_ARRAY_TYPE:
        *ip++ = gc->vertexArray.np_type;
        break;
      case GL_NORMAL_ARRAY_STRIDE:
        *ip++ = gc->vertexArray.np_usr_stride;
        break;
      case GL_NORMAL_ARRAY_COUNT_EXT:
        *ip++ = gc->vertexArray.np_count;
        break;
      case GL_COLOR_ARRAY_SIZE:
        *ip++ = gc->vertexArray.cp_size;
        break;
      case GL_COLOR_ARRAY_TYPE:
        *ip++ = gc->vertexArray.cp_type;
        break;
      case GL_COLOR_ARRAY_STRIDE:
        *ip++ = gc->vertexArray.cp_usr_stride;
        break;
      case GL_COLOR_ARRAY_COUNT_EXT:
        *ip++ = gc->vertexArray.cp_count;
        break;
      case GL_INDEX_ARRAY_TYPE:
        *ip++ = gc->vertexArray.ip_type;
        break;
      case GL_INDEX_ARRAY_STRIDE:
        *ip++ = gc->vertexArray.ip_usr_stride;
        break;
      case GL_INDEX_ARRAY_COUNT_EXT:
        *ip++ = gc->vertexArray.ip_count;
        break;
      case GL_TEXTURE_COORD_ARRAY_SIZE:
        *ip++ = gc->vertexArray.tp_size;
        break;
      case GL_TEXTURE_COORD_ARRAY_TYPE:
        *ip++ = gc->vertexArray.tp_type;
        break;
      case GL_TEXTURE_COORD_ARRAY_STRIDE:
        *ip++ = gc->vertexArray.tp_usr_stride;
        break;
      case GL_TEXTURE_COORD_ARRAY_COUNT_EXT:
        *ip++ = gc->vertexArray.tp_count;
        break;
      case GL_EDGE_FLAG_ARRAY_STRIDE:
        *ip++ = gc->vertexArray.ep_usr_stride;
        break;
      case GL_EDGE_FLAG_ARRAY_COUNT_EXT:
        *ip++ = gc->vertexArray.ep_count;
        break;
...
void APIENTRY __glim_GetDoublev(GLenum sq, GLdouble result[])
{
    __glDoGet(sq, result, __GL_FLOAT64, "glGetDoublev");
}

void APIENTRY __glim_GetFloatv(GLenum sq, GLfloat result[])
{
    __glDoGet(sq, result, __GL_FLOAT32, "glGetFloatv");
}

void APIENTRY __glim_GetIntegerv(GLenum sq, GLint result[])
{
    __glDoGet(sq, result, __GL_INT32, "glGetIntegerv");
}

void APIENTRY __glim_GetBooleanv(GLenum sq, GLboolean result[])
{
...
*/
GLenum APIENTRY __glim_GetError(void)
{
    GLint error;
...
void APIENTRY __glim_GetPointerv(GLenum pname,
                                 void **params) 
{
    __GL_SETUP_NOT_IN_BEGIN();
    __GL_API_GET();
    ...
    switch(pname) {
      case GL_VERTEX_ARRAY_POINTER:
        *params = (void *)gc->vertexArray.vertex_pointer;
        return;
      case GL_NORMAL_ARRAY_POINTER:
        *params = (void *)gc->vertexArray.normal_pointer;
        return;
      case GL_COLOR_ARRAY_POINTER:
        *params = (void *)gc->vertexArray.color_pointer;
        return;
      case GL_INDEX_ARRAY_POINTER:
        *params = (void *)gc->vertexArray.index_pointer;
        return;
      case GL_TEXTURE_COORD_ARRAY_POINTER:
        *params = (void *)gc->vertexArray.tex_coord_pointer;
        return;
      case GL_EDGE_FLAG_ARRAY_POINTER:
        *params = (void *)gc->vertexArray.edge_pointer;
        return;
