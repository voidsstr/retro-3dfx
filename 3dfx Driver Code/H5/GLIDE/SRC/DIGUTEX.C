...
**
** $Header: digutex.c, 2, 10/11/00 8:21:06 PM, Brent$
** $Log: 
...
** $
** 
** 12    4/07/99 9:36a Dow
** Fixed for call before winopen
** 
...
{
  GR_DCL_GC;
  const FxI32 saveLevel = 99;
  static char myName[]="guTexMemQueryAvail";
  gc->myLevel = 99;
  GDBG_INFO(gc->myLevel, "guTexMemQueryAvail");
  GDBG_INFO_MORE(gc->myLevel,"(%d)\n",tmu);
  GR_CHECK_TMU( myName, tmu );
