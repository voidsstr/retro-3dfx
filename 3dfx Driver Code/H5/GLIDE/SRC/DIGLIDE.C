...
**
** $Header: diglide.c, 2, 10/11/00 8:21:05 PM, Brent$
** $Log: 
...
GR_DIENTRY(grGlideInit, void, (void))
{
  ...
  /* Work around for MangoGrits that calls some grXXX state call
   * before calling grSstWinOpen which inits the command fifo.  
   * See gsst.c:grSstWinOpen for more of this shit.
   */
  {
