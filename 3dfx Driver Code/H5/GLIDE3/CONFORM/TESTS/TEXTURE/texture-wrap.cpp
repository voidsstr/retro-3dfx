...
static char *test_name = "texture-wrap";
static char *test_description = "Test wrapping of single level textures";
...
int do_conform(conform_state *state)
{
  ...
  for(type = 0; type < 4 ; type++) {
	...
	case 2:
	  grTexClampMode(local_ptr->curtmu, 
			 GR_TEXTURECLAMP_WRAP, GR_TEXTURECLAMP_CLAMP);
	  break;
	default:
	  grTexClampMode(local_ptr->curtmu, 
