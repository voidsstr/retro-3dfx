...
static char *test_name = "alpha-test";
static char *test_description = "Test alpha test functionality";
...
int do_conform(conform_state *state)
{
  ...
  for(value = 0; value < 5; value++) {
	...
	break;
      case 3:
	grAlphaTestReferenceValue(0x04);
	break;
      case 4:
	grAlphaTestReferenceValue(0xCC);
	break;
      default:
