...
static char *test_name = "alpha-blend";
...
// local data
typedef struct {
  GrVertex verts[8];  // Temporary vertex storage
...
int do_conform(conform_state *state)
{
  ...
  FxI32 fog_entries = MAX_FOG_ENTRY + 10; // default it to bigger
  ...
  for(src = 0; src < 6; src++) {
	...
	break;
      case 2:
	sf = GR_BLEND_DST_COLOR;
	break;
      case 3:
	sf = GR_BLEND_ONE_MINUS_DST_COLOR;
	break;
      case 4:
	sf = GR_BLEND_SRC_ALPHA;
	break;
      case 5:
	sf = GR_BLEND_ONE_MINUS_SRC_ALPHA;
	break;
      default:
	sf = GR_BLEND_ZERO;
	break;
	...
	break;
      case 2:
	df = GR_BLEND_SRC_COLOR;
	break;
      case 3:
	df = GR_BLEND_ONE_MINUS_SRC_COLOR;
	break;
      case 4:
	df = GR_BLEND_SRC_ALPHA;
	break;
      case 5:
	df = GR_BLEND_ONE_MINUS_SRC_ALPHA;
	break;
      default:
	df = GR_BLEND_ZERO;
	break;
...
void setup_prim(conform_state *state)
{
  ...
  guFogGenerateExp2(local_ptr->table, 0.5f);
