...
**
** $Header: gpci.c, 43, 10/11/00 8:27:09 PM, Brent$
** $Log: 
...
#ifdef Q3D_FC_PERFORMANCE_TRILINEAR
  _GlideRoot.environment.forcePerformanceTrilinear = GLIDE_GETENV("FX_GLIDE_PERFORMANCE_TRILINEAR_Q3D", 0);
#endif
