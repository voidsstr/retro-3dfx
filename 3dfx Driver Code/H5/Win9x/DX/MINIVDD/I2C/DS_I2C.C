/* $Header: ds_i2c.c, 8, 10/11/00 8:55:45 PM, Brent$ */
/*
...
**
** $Log: 
**  8    3dfx      1.5.1.0.1.0 10/11/00 Brent           Forced check in to enforce
**       branching.
**  7    3dfx      1.5.1.0     05/18/00 Dan O'Connel    Major clean up of DFP
...
//???obsolete    SetUsageI2C(pContext, busid, I2C_LCDSCALER);
