...
**
** $Revision: 2$
** $Date: 10/11/00 8:19:49 PM$
*/
/* This test is a very simple test of the video backend, using the vidutils.c
file
This also tests the clut select line for the desktop.
*/
...
main (int argc, char **argv)
{
    ...
    sst = SST_BEGIN(argc,argv);
	 ...
	 tmp |= SST_OVERLAY_CLUT_BYPASS | SST_DESKTOP_CLUT_SELECT; // turn of clut
	 ...
	 tmp = (0xaa<<(19-7)); //Zoom up by a lot 
