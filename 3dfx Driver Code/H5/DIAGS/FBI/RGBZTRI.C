...
main (int argc, char **argv)
{
	...
	setupTriangle(&t,1,0,1);		// setup RGBZ slopes
	...
	checkTriangle(&t,1,1,diago.adjust, insideTriangle,1,0,1);
	...
	SET(sst->dbdy,0);
	SET(sst->dzdy,0);
	drawTriangle(sst,&t,0,0,0);		// erase the triangle
    }
