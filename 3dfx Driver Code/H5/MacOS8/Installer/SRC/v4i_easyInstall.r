...
resource 'inrl' (700) {
  format0 {{
    ...
    AddPackages{{ kAllVoodoo4Packages }},
    AddUserDescription{ "Click the Install button to place the MacVoodoo drivers on the selected disk. This installation will include all the recommended software for this Macintosh." },
  }}
};
