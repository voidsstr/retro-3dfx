/* -*-c++-*- */
/* $Header: bt868.c, 28, 10/11/00 8:57:58 PM, Brent$ */
/*
...
**
** $Revision: 28$
** $Date: 10/11/00 8:57:58 PM$
**
** $Log: 
**  28   3dfx      1.25.2.0.1.010/11/00 Brent           Forced check in to enforce
**       branching.
**  27   3dfx      1.25.2.0    05/22/00 Dan O'Connel    Major clean up of DFP
...
#ifndef WINNT
// protoDfpBoard controls whether the reset for the bt868 is cleared or not.  Normally
// this is done by the BIOS, but sometimes on prototype hardware you run with a
// BIOS that doesn't support TvOut or for other reasons hasn't done this.  I don't 
// know of any reasons the the driver can't do this anyway.
//???#define protoDfpBoard 1
#ifdef protoDfpBoard
   // insure the BT868 is not being held in reset      //??? temp for prototype DFP board
