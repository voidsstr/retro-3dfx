...
**
** $Revision: 17$
** $Date: 10/11/00 8:43:11 PM$
**
** $Log: 
**  17   3dfx      1.13.3.2    10/11/00 Brent           Forced check in to enforce
**       branching.
**  16   3dfx      1.13.3.1    08/11/00 Russ Lind       merge of various w9x
**       changes into w2k
**       including
**         LODBIASPERCHIP
**         LODDITHER
...
**  15   3dfx      1.13.3.0    07/26/00 Daoxiang Gong   Fixed PRS 14903. Enable
