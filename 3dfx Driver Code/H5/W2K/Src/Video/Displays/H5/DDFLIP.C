/* $Header: ddflip.c, 27, 10/11/00 8:43:43 PM, Brent$ */
/*
...
// can't use DD_ENTRY_SETUP because CMDFIFO need pdev
...
#if defined(CMDFIFO)
  {
	...
	else
	{
       ...
       if (MAXPENDINGBUFFERS_TOAVOIDHANG < swapsQueued)
         swapsQueued = MAXPENDINGBUFFERS_TOAVOIDHANG;
		}
		else
		{
