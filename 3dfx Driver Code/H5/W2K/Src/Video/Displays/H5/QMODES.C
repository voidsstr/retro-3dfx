...
**
** $Revision: 5$
** $Date: 10/11/00 8:44:27 PM$
** $Log: 
**  5    3dfx      1.2.1.0.1.0 10/11/00 Brent           Forced check in to enforce
**       branching.
**  4    3dfx      1.2.1.0     05/18/00 Dan O'Connel    Major clean up of DFP
...
** 
**  3    3dfx      1.2         11/10/99 Dan O'Connel    Port current DFP support
**       from WinNT.
**  2    3dfx      1.1         10/01/99 Dan O'Connel    Port "3dfx Tools" support,
**       TvOut support, and a few misc. bug fixes from WinNt4 to Win2K.
