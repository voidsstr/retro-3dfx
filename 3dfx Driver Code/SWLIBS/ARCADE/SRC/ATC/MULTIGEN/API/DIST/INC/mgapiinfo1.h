/*******************************************************************************
 * 
 * $Header: mgapiinfo1.h, 4, 10/11/00 7:32:20 PM, Brent$
 * $Revision: 4$
...
extern APIFUNC(void) mgPrintField ( mgrec* rec );
extern APIFUNC(void) mgPrintRec ( mgrec* rec );
extern APIFUNC(mgbool) mgGetError ( char **siteid, char **message );
