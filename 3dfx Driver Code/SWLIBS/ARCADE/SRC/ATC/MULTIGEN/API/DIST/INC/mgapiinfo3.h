/*******************************************************************************
 * 
 * $Header: mgapiinfo3.h, 4, 10/11/00 7:32:20 PM, Brent$
 * $Revision: 4$
 * $Date: 10/11/00 7:32:20 PM$
 *
 ******************************************************************************/
...
extern APIFUNC(mgbool) mgSendError ( char *siteid, int errorCode, ... );
extern APIFUNC(mgbool) mgSendWarning ( char *siteid, int errorCode, ... );
extern APIFUNC(mgbool) mgSendStatus ( char *siteid, int errorCode, ... );
extern APIFUNC(mgbool) mgSetError ( char *siteid, int errorCode, ... );
