/*******************************************************************************
 * 
 * $Header: lapimaterial.h, 4, 10/11/00 7:32:01 PM, Brent$
 * $Revision: 4$
 * $Date: 10/11/00 7:32:01 PM$
 *
 ******************************************************************************/
...
#ifndef LAPIMATERIAL_H_
#define LAPIMATERIAL_H_

#pragma message("lapimaterial.h is obsolete, use mgapimaterial.h")
