/*******************************************************************************
 * 
 * $Header: mgapipref1.h, 4, 10/11/00 7:32:34 PM, Brent$
 * $Revision: 4$
 * $Date: 10/11/00 7:32:34 PM$
 *
 ******************************************************************************/
...
/*============================================================================*/
extern APIFUNC(void) mgSetOpenCreateFlag ( mgbool flag );
extern APIFUNC(void) mgSetNewOverwriteFlag ( mgbool flag );
