/*******************************************************************************
 * 
 * $Header: mgapimem1.h, 4, 10/11/00 7:32:32 PM, Brent$
 * $Revision: 4$
 * $Date: 10/11/00 7:32:32 PM$
 *
 ******************************************************************************/
...
extern APIFUNC(void) *mgMalloc ( unsigned int byte_size );
extern APIFUNC(void) mgFree ( void *ptr );
