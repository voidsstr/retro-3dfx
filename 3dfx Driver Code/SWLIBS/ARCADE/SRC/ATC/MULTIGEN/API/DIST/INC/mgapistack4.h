/*******************************************************************************
 * 
 * $Header: mgapistack4.h, 4, 10/11/00 7:32:36 PM, Brent$
 * $Revision: 4$
 * $Date: 10/11/00 7:32:36 PM$
 *
 ******************************************************************************/
...
#ifndef MGAPISTACK4_H_
#define MGAPISTACK4_H_
...
extern APIFUNC(void) *mgTopElem ( owll *head );
extern APIFUNC(owll) *mgPush ( owll **head,  void *ptr );
extern APIFUNC(owll) *mgPop ( owll **head );
extern APIFUNC(void) *mgPopElem ( owll **head );
extern APIFUNC(owll) *mgClearStack ( owll **head );
