/*******************************************************************************
 * 
 * $Header: mgapiutil1.h, 4, 10/11/00 7:32:43 PM, Brent$
 * $Revision: 4$
 * $Date: 10/11/00 7:32:43 PM$
 *
 ******************************************************************************/
...
extern APIFUNC(mgbool) mgGetPolyNormal ( mgrec* rec, double* nx, double* ny, double* nz );

extern APIFUNC(mgbool) mgIsPolyConcave ( mgrec* rec );
extern APIFUNC(mgbool) mgGetVtxNormal ( mgrec* rec, float *i, float *j, float *k );
