/* $Header: di_i2c.c, 7, 10/11/00 7:40:39 PM, Brent$ */
/*
...
**
** $Log: 
**  7    3dfx      1.5.4.0     10/11/00 Brent           Forced check in to enforce
**       branch.
**  6    3dfx      1.5         07/20/00 Andrew  Bell    Rolling back all swlibs
**       files to 2nd latest version due to an incorrect checkin.  This should
**       bring things back to normal.
**  5    3dfx      1.4         07/19/00 Dinesh Raja Savari Amirtharaj CSIM for the
**       RTL release_3_2
**  4    3dfx      1.3         06/26/00 Ryan Bissell    Removed old debug spew that
...
int i2c_sendbyte(I2CCONTEXT pContext, I2CKEY key, FxU8 byte)
{
  ...
  DEBUGI2C(!ack,    ("I2C: sendbyte(\"Slave took too long to acknowledge.\")\n"));
