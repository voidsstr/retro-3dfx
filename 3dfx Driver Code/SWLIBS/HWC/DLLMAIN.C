...
/* GMT: fxhwc.h just not worth including */
#ifdef __cplusplus
extern "C" void   FX_CALL hwcShutdown(void);
#else
extern void   FX_CALL hwcShutdown(void);
#endif
