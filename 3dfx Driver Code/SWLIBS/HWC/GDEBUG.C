...
FILE *gdbg_msgfile = stdout;	// GDBG info/error file
...
//----------------------------------------------------------------------
FX_EXPORT void FX_CSTYLE
gdbg_vprintf (int cont, const char *format,va_list args)
{
