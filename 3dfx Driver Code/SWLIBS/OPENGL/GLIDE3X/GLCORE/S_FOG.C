...
/*
** Fast power function for fogging courtesy of Dave B.  The
** exponent is E, so use an approximation...
**
** from 3Dlabs, could also use lut?
*/
float __glFogPow(float x)
{
    float x2, x3;
    float f, f2, f4;
    ...
    f  = 1.0 + 0.2507213 * x + 0.0292732 * x2 + 0.0038278 * x3;
    f2 = f * f;
    f4 = f2 * f2;
...
{
    __GLfloat fog, oneMinusFog, density, end;
    __GLcolor *fogColor;
...
{
    __GLfloat eyeZ, fog, density, end;
