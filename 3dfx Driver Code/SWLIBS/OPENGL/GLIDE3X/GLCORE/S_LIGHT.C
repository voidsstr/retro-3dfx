...
#if 1
   {
      float gc_frontbuffer_redscale   = gc->frontBuffer.redScale;
      float gc_frontbuffer_greenscale = gc->frontBuffer.greenScale;
      float gc_frontbuffer_bluescale  = gc->frontBuffer.blueScale;
