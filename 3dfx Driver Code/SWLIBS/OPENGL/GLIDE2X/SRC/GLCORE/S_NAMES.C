...
/*
** Display list routines referred to in dataInfo structures.
** Defined in dl_table.c.
*/
...
/*
** Texture Object routines referred to in dataInfo structures.
** Defined in soft/so_texture.c (for the core rendering library).
*/
extern void __glDisposeTexObj(__GLcontext *gc, void *pData);
extern void __glEmptyFreeTexObj(__GLcontext *gc, __GLtextureObject *texobj);

#if 0
/*
** Empty data structure for texture objects.
** This structure isn't as crucial for texture objects as it is for
** display lists.
*/
static  __GLtextureObject emptyTexObj = {
	1,			/* refcount */
	__glEmptyFreeTexObj,	/* free */
	  			/* texture machine... */
};
#endif
