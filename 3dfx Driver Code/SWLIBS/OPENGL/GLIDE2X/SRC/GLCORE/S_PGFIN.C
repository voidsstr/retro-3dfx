...
static void OtherTFanVertex(__GLcontext *gc, __GLvertex *v0)
{
    ...
    /* Clip check */
    orCodes = (v0->hasAndClipCode | v1->hasAndClipCode | v2->hasAndClipCode) & __GL_ALL_CLIP_MASK;
    if (orCodes) {
	/* Some kind of clipping is needed */
	andCodes = v0->hasAndClipCode & v1->hasAndClipCode & v2->hasAndClipCode & __GL_ALL_CLIP_MASK;
	if (andCodes) {
...
void __glEvenTStripVertex(__GLcontext *gc, __GLvertex *v0)
{
    ...
    gc->vertex.v1 = v0;
    gc->vertex.v2 = v1;
    gc->procs.vertex = __glOddTStripVertex;
...
void __glOddTStripVertex(__GLcontext *gc, __GLvertex *v0)
{
    ...
    gc->vertex.v1 = v0;
    gc->vertex.v2 = v1;
    gc->procs.vertex = __glEvenTStripVertex;
...
static void ThirdTrianglesVertex(__GLcontext *gc, __GLvertex *v0)
{
    ...
    /* Clip check */
    orCodes = (v0->hasAndClipCode | vbuf0->hasAndClipCode | vbuf1->hasAndClipCode) & __GL_ALL_CLIP_MASK;
    if (orCodes) {
	/* Some kind of clipping is needed */
	andCodes = (v0->hasAndClipCode & vbuf0->hasAndClipCode & vbuf1->hasAndClipCode) & 
	    __GL_ALL_CLIP_MASK;
	if (andCodes) {
	    /* Trivially reject the triangle */
	} else {
...
static void FourthQStripVertex(__GLcontext *gc, __GLvertex *v0)
{
    ...
    /* Clip Check */
    orCodes = (v0->hasAndClipCode | v1->hasAndClipCode | v2->hasAndClipCode | v3->hasAndClipCode) &
	__GL_ALL_CLIP_MASK;
    if (orCodes) {
	/* Some kind of clipping is needed */
	andCodes = v0->hasAndClipCode & 
	    v1->hasAndClipCode & 
	    v2->hasAndClipCode & 
	    v3->hasAndClipCode & 
	    __GL_ALL_CLIP_MASK;
...
static void FourthQuadsVertex(__GLcontext *gc, __GLvertex *v0)
{
    ...
    /* Clip Check */
    orCodes = (v0->hasAndClipCode | va->hasAndClipCode | vb->hasAndClipCode | vc->hasAndClipCode) & __GL_ALL_CLIP_MASK;
    if (orCodes) {
	/* Some kind of clipping is needed */
	andCodes = v0->hasAndClipCode & va->hasAndClipCode & vb->hasAndClipCode & vc->hasAndClipCode & __GL_ALL_CLIP_MASK;
	if (andCodes) {
	    /* Trivially reject the quad */
	} else {
	    /* Clip the quad as a polygon */
