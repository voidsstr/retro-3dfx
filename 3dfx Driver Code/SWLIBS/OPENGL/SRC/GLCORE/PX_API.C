...
*/
void APIENTRY __glim_PixelStoref(GLenum mode, GLfloat value)
{
    switch (mode) {
...
void APIENTRY __glim_PixelStorei(GLenum mode, GLint value)
{
    __GLpixelState *ps;
...
*/
void APIENTRY __glim_PixelZoom(GLfloat xfactor, GLfloat yfactor)
{
    __GLpixelState *ps;
    GLint xtemp, ytemp;
    __GL_SETUP_NOT_IN_BEGIN();
...
*/
void APIENTRY __glim_PixelTransferf(GLenum mode, GLfloat value)
{
    __GLpixelState *ps;
    __GL_SETUP_NOT_IN_BEGIN();
    __GL_API_BLAND();
...
void APIENTRY __glim_PixelTransferi( GLenum mode, GLint value)
{
...
*/
void APIENTRY __glim_PixelMapfv(GLenum map, GLint mapSize,
...
void APIENTRY __glim_PixelMapuiv(GLenum map, GLint mapSize,
			const GLuint values[])
{
    __GLpixelState *ps;
    __GLpixelMapHead *pMap;
...
void APIENTRY __glim_PixelMapusv(GLenum map, GLint mapSize,
...
*/
void APIENTRY __glim_ReadBuffer(GLenum mode)
{
    __GL_SETUP_NOT_IN_BEGIN();
    __GL_API_BLAND();
...
void APIENTRY __glim_DrawPixels(GLsizei width, GLsizei height, GLenum format,
...
void APIENTRY __glim_ReadPixels(GLint x, GLint y, GLsizei width, GLsizei height, 
...
void APIENTRY __glim_CopyPixels(GLint x, GLint y, GLsizei width, GLsizei height,
		       GLenum type)
{
    GLenum format;
    GLuint beginMode;
