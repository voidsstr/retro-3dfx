...
void __glRenderAliasLine(__GLcontext *gc, __GLvertex *v0, __GLvertex *v1)
{
	...
	*/
	...
	__GLfloat v0S, v1S, v0T, v1T, v0QW, v1QW;
	...
	*/
	...
	gc->polygon.shader.frag.s = v0S + dS * offset;
	gc->polygon.shader.frag.t = v0T + dT * offset;
	gc->polygon.shader.frag.qw = v0QW + dQWdX * offset;

	v0rhow = (*gc->procs.calcLineRho)(gc, v0S, v0T, v0QW) * v0QW;

	v1rhow = (*gc->procs.calcLineRho)(gc, v1S, v1T, v1QW) * v1QW;

	drhow = (v1rhow - v0rhow) * invDelta;
	gc->polygon.shader.drhowdx = drhow;
	gc->polygon.shader.frag.rhow = v0rhow + drhow * offset;
    } 
