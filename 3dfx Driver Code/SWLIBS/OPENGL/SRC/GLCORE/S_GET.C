			      ...
			      GLenum pname, GLfloat v[])
{
	...
	{
	    __GLtexture *pto;
	    pto = __glLookUpTexture(gc, target);
	    v[0] = (GLfloat)(pto->residence);
	}
	break;
      default:
	__glSetError(GL_INVALID_ENUM);
			...
			GLvoid *texels)
{
    ...
    (*gc->procs.fetchTex)(gc, tex, &spanInfo, GL_TRUE);
}
...
void APIENTRY __glim_GetPointervEXT(GLenum pname,
				    void **params)
{
