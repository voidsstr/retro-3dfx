/*
 * txdlim1_3.c - test combination of the display lists 1 
 * components textures
 */
...
TESTMOD(txdl1_3)
{
    GLint width, height, lod, majer, size_x, size_y, maxLod, i;
    GLubyte *t;
	...
	glNewList(101 + lod, GL_COMPILE);
        glTexImage2D(GL_TEXTURE_2D, lod, 1, size_x, size_y, 0,
                                GL_LUMINANCE, GL_UNSIGNED_BYTE, texture[lod]);
	glEndList();
