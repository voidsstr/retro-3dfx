/*
 * unsign14.c - test unsigned textures: number of source components is 1,
	...
	switch( i % 18 ){
	  case 0:
	    glTexImage2D(GL_TEXTURE_2D, 0, 4, TEXSIZE, TEXSIZE, 0, 
				GL_LUMINANCE, GL_UNSIGNED_BYTE, tubyte);
	    break;

	  case 1:
	    glTexImage2D(GL_TEXTURE_2D, 0, 4, TEXSIZE, TEXSIZE, 0, 
				GL_RED, GL_UNSIGNED_BYTE, tubyte);
	    break;

	  case 2:
	    glTexImage2D(GL_TEXTURE_2D, 0, 4, TEXSIZE, TEXSIZE, 0, 
				GL_GREEN, GL_UNSIGNED_BYTE, tubyte);
	    break;

	  case 3:
	    glTexImage2D(GL_TEXTURE_2D, 0, 4, TEXSIZE, TEXSIZE, 0, 
				GL_BLUE, GL_UNSIGNED_BYTE, tubyte);
	    break;

	  case 4:
	    glTexImage2D(GL_TEXTURE_2D, 0, 4, TEXSIZE, TEXSIZE, 0, 
				GL_ALPHA, GL_UNSIGNED_BYTE, tubyte);
	    break;
	  ...
	  case 6:
	    glTexImage2D(GL_TEXTURE_2D, 0, 4, TEXSIZE, TEXSIZE, 0, 
				GL_LUMINANCE, GL_UNSIGNED_SHORT, tushort);
	    break;

	  case 7:
	    glTexImage2D(GL_TEXTURE_2D, 0, 4, TEXSIZE, TEXSIZE, 0, 
				GL_RED, GL_UNSIGNED_SHORT, tushort);
	    break;

	  case 8:
	    glTexImage2D(GL_TEXTURE_2D, 0, 4, TEXSIZE, TEXSIZE, 0, 
				GL_GREEN, GL_UNSIGNED_SHORT, tushort);
	    break;

	  case 9:
	    glTexImage2D(GL_TEXTURE_2D, 0, 4, TEXSIZE, TEXSIZE, 0, 
				GL_BLUE, GL_UNSIGNED_SHORT, tushort);
	    break;

	  case 10:
	    glTexImage2D(GL_TEXTURE_2D, 0, 4, TEXSIZE, TEXSIZE, 0, 
				GL_ALPHA, GL_UNSIGNED_SHORT, tushort);
	    break;
	  ...
	  case 12:
	    glTexImage2D(GL_TEXTURE_2D, 0, 4, TEXSIZE, TEXSIZE, 0, 
				GL_LUMINANCE, GL_UNSIGNED_INT, tuint);
	    break;

	  case 13:
	    glTexImage2D(GL_TEXTURE_2D, 0, 4, TEXSIZE, TEXSIZE, 0, 
				GL_RED, GL_UNSIGNED_INT, tuint);
	    break;

	  case 14:
	    glTexImage2D(GL_TEXTURE_2D, 0, 4, TEXSIZE, TEXSIZE, 0, 
				GL_GREEN, GL_UNSIGNED_INT, tuint);
	    break;

	  case 15:
	    glTexImage2D(GL_TEXTURE_2D, 0, 4, TEXSIZE, TEXSIZE, 0, 
				GL_BLUE, GL_UNSIGNED_INT, tuint);
	    break;

	  case 16:
	    glTexImage2D(GL_TEXTURE_2D, 0, 4, TEXSIZE, TEXSIZE, 0, 
				GL_ALPHA, GL_UNSIGNED_INT, tuint);
	    break;
	  case 17:
	    glTexImage2D(GL_TEXTURE_2D, 0, 4, 0, TEXSIZE, 0, 
				GL_ALPHA, GL_UNSIGNED_INT, tuint);
