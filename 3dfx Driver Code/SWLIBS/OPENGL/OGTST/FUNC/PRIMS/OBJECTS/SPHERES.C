/*
 *  spheres.c - $Revision: 2$
 *
 */

/*
 * tests the gluSphere primitive
 */
...
static float lt_amb[4] = {0, 0, 0};
static float lt_diff[4] = {1, 1, 1};
static float lt_spec[4] = {1, 1, 1};
