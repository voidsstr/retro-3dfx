/*
 * "$Id: sgilib.c,v 1.1 1997/07/07 07:36:52 gold Exp $"
 *
 ...
 *   $
 * 
 * 1     11/18/97 4:36p Simon
 * Ogtst from the Oct 1997 opengl distribution from SGI.
 * 
 * 1     11/18/97 3:48p Simon
 * OpenGL distributions from SGI for August 97 and October 97.
 * Revision 1.1  1997/07/07  07:36:52  gold
 * sgi image support
 *
            ...
            int   xsize)/* I - Width of data in pixels */
{
  ...
  for (x = xsize, length = 0; x > 0;)
  {
    ...
    while (count > 0)
    {
      ...
      if (putshort((short) 128 | i, fp) == EOF)
        return (-1);
      length ++;
...
/*
 * End of "$Id: sgilib.c,v 1.1 1997/07/07 07:36:52 gold Exp $".
 */
